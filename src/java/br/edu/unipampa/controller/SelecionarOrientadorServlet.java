 ...
 * @author Pedro
 */
public class SelecionarOrientadorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario == null) {
            ...
            if (acessoSistema.procurarCoordenador(usuario) == null) {
                ...
                selecionarOrientador(request, response);
            }
        }

    }

    public void selecionarOrientador(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        AcessoSistema acessoSistema = new AcessoSistema();
