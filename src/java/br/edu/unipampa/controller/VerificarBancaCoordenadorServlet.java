 ...
 * @author Pedro
 */
public class VerificarBancaCoordenadorServlet extends HttpServlet {
    ...
    public void verificarBanca(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("Banca/verificarBancaCoordenador.jsp").forward(request, response);
    }
